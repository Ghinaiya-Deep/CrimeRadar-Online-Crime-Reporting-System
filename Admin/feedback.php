        ...
        <div class="container">
            ...
            <table border="1">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM feedback"; // Assuming table name is 'users'
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        <td>{$row['name']}</td>
                        <td>{$row['email']}</td>
                        <td>{$row['police_station_id']}</td>
                        <td>{$row['feedback']}</td>
                        <td>{$row['rating']}</td>
                        <td>
                            <a href='delete_feedback.php?id={$row['feedback_id']}' class='delete-btn' onclick='return confirm(\"Are you sure?\")'>Delete</a>
                        </td>
                    </tr>";
                        }
                    } else {
