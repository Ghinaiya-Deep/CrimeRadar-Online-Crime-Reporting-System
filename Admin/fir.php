...
// Fetch FIR details 
$stmt = $con->prepare("SELECT * FROM fir ");
$stmt->execute();
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                        <td>" . htmlspecialchars($row['fir_no']) . "</td>
                        <td>" . htmlspecialchars($row['crime_id']) . "</td>
                        <td>" . htmlspecialchars($row['date_time_incident']) . "</td>
                        <td>" . htmlspecialchars($row['complainant_name']) . "</td>
                        <td>" . htmlspecialchars($row['complainant_address']) . "</td>
                        <td>" . htmlspecialchars($row['complainant_contact']) . "</td>
                        ...
                        <td>
                    <a href='" . htmlspecialchars("../Police Officer/Police Stations/fir_details.php?crime_id=" . urlencode($row['crime_id']) . "&role=admin") . "' class='view-btn'>
                        View FIR
                    </a>
                </td>
                    </tr>";
